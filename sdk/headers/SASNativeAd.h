 ...
 */
@property (nonatomic, readonly, nullable) SASNativeAdImage *icon;
 ...
 */
@property (nonatomic, readonly, nullable) SASNativeAdImage *coverImage;

/**
 The 'sponsored by' message of the ad.
 Generally contains the brand name of the sponsor.
 */
@property (nonatomic, readonly, nullable) NSString *sponsored;
...
@property (nonatomic, assign, nullable) id <SASNativeAdDelegate> delegate;
