...
#define kSASSDKVersion						@"6.2"
#define kSASSDKRev                          @"3839383632"
...
@class SASRequestManager, SASORMMAController, SASLoaderView, SASMRAIDBridge, SASAdViewController;
...
@property (nonatomic, assign, nullable) id <SASAdViewDelegate> delegate;
...
@property (nonatomic, assign, nullable) UIViewController *modalParentViewController;
