...
- (void)load {
	//Do not forget to set the delegate and the modalParentViewController to nil before loosing last reference to the interstitial (because the interstitial will be automatically released by ARC)
    _interstitial.delegate = nil;
    _interstitial.modalParentViewController = nil;
...
- (void)createInterstitial {
	...
	[_interstitial loadFormatId:12167 pageId:@"188763" master:YES target:[MOCAAds getTarget]];
