...
- (void)dealloc {
	//The banner is released automatically by ARC but the delegate and the modalParentViewController should be set to nil to prevent crashes during fast navigation in the application.
    ...
    _banner.modalParentViewController = nil;
...
- (void)reload {
	//Do not forget to set the delegate and the modalParentViewController to nil before loosing last reference to the banner (because the banner will be automatically released by ARC)
    _banner.delegate = nil;
    _banner.modalParentViewController = nil;
...
- (void)createBanner {
	...
	[_banner loadFormatId:12161 pageId:@"188761" master:YES target:[MOCAAds getTarget]];
