...
class ToasterViewController: UIViewController, SASAdViewDelegate {
	...
	deinit {
		// The toaster is automatically released by ARC but the delegate and the modalParentViewController should be set to nil to prevent crashes during fast navigation in the application.
        ...
        toaster?.modalParentViewController = nil
	...
	func createToaster() {
		...
		if let actualToaster = toaster {
            ...
            actualToaster.modalParentViewController = self
			...
			actualToaster.translatesAutoresizingMaskIntoConstraints = true
		}
	}
	...
	func removeToaster() {
		if let actualToaster = toaster {
            ...
            actualToaster.modalParentViewController = nil
